...
} from "./ingredient.dto.ts";
import {
  Recette,
  RecetteCandidate,
  RecetteCategorie,
} from "../../services/models/recette.model.ts";
...
export function fromRecetteCandidateDtoToRecetteCandidate(
  recetteCandidateDto: RecetteCandidateDto,
): RecetteCandidate {
  return {
    ...recetteCandidateDto,
  };
